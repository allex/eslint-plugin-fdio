...
export default createRule<Options, MessageIds>({
  ...
  create(context, [options]) {
    ...
    function checkLastToken(
      member: TSESTree.TypeElement | TSESTree.PropertyDefinition,
    ...
    function checkClassPropertyStyle(
      node: TSESTree.PropertyDefinition,
    ): void {
      const opts = {
        ...interfaceOptions.singleline,
        type: 'single-line',
      };
      checkLastToken(node, opts, false);
    }

    return {
      TSInterfaceBody: checkMemberSeparatorStyle,
      TSTypeLiteral: checkMemberSeparatorStyle,
      PropertyDefinition: checkClassPropertyStyle,
    };
  },
});
